...
def run(request):
    ...
    return(
        f"{most_important[0]} tasks contributed the most to your happiness ({most_important[1]}) and {most_harmful[0].lower()} tasks took the largest toll on it ({most_harmful[0]})"
    )
